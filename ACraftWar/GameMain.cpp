...
bool GameMain::LoadData()
{
    ...
    VT(string) player_path_list = { "image\\player.png" };
...
void GameMain::InitTObj()
{
    ...
    VT(string) tr_path_list2 = { "image\\air_green.png" };
    ...
    VT(string) tr_path_list3 = { "image\\air_green.png" };
...
void GameMain::RenderTimeDown(bool is_active)
{
    ...
    string str_val = std::to_string(m_TimeDown);
    string str_time = "Time: " + str_val;

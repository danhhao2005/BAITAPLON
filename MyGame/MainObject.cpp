...
void MainObject::HanleInputAction(SDL_Event events, SDL_Renderer* screen)
{
...
{
    x_val_ = 0;
    y_val_ += GRAVITY_SPEED; //toc do roi cua player
...
void MainObject::CenterEntyOnMap(Map& map_data)
{
